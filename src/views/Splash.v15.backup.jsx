...
export default function Splash() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#09090B] flex flex-col items-center justify-center">
      ...
      <motion.img
        ...
        className="absolute right-[-10%] bottom-0 h-[85vh] opacity-90 pointer-events-none"
      />
